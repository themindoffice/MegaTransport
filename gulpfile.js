...
var jsPath			= "app/js";
var viewsPath		= "app/php/misc/views.php";
var controllersPath	= "app/php/misc/controllers.php";
var htmlDest 		= "build/";
...
gulp.task('build_php', ['build_folders'], () => {
	...
	gulp.src([pagesPath + "/*.php"])
		...
		.pipe(gulpreplace(/slir{(.*?)}/g, function(match) {
			var start 	= match.indexOf('{') + 1;
			var end 	= match.indexOf('}');
			var result 	= match.substring(start, end);
			result 		= result.replace(' ', '');
